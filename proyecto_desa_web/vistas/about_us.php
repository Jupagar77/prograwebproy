...
<head>
    ...
    <title>Sobre nosostros | Contacto</title>
...
<main class="centrar_main_home centrar_main_ayuda">
    <div>
        ...
        <hr />
          ...
          <article>
              <h2>Juan Pablo Gutierrez</h2>
              <p>
                  <i>Estudiante Curso Desarrollo WEB, UNA 2018.</i>
              </p>
        <hr />
              <h2>Gerson Vargas Gálvez</h2>
              <p>
                  <i>Estudiante Curso Desarrollo WEB, UNA 2018.</i>
              </p>
    </article>
